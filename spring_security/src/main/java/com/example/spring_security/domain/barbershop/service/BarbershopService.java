package com.example.spring_security.domain.barbershop.service;
...
public class BarbershopService {
    ...
    // registro/criação para barbershop
    public String registerBarbershop(RegisterBarbershopDTO data){
