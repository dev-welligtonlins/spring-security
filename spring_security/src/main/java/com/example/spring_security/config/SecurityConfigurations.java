...
import com.example.spring_security.core.auth.filter.SecurityFilter;
import com.example.spring_security.core.auth.service.AuthUserDetailsService;
...
public class SecurityConfigurations {
    ...
    private final AuthUserDetailsService authorizationService;
    
    public SecurityConfigurations(SecurityFilter securityFilter, AuthUserDetailsService authorizationService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers(HttpMethod.PUT, "/services/**").hasRole("BARBERSHOP")
